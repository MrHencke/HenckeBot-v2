...
module.exports = {
    name: 'syng',
    description: 'Brukes ved !syng <tittel på sang>, Synger en sang i voice',
  category: 'meme',
    aliases: ['singstar'],
    execute(bot, msg, args) {
      var Title = args.join(' ');
        ...
        sound(discordTTS.getVoiceStream(resultata[0]), msg.member.voice.channel, msg, resultata, i = 0)
        }    
}).catch(error => {
