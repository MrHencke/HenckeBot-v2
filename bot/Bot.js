...
bot.on("message", msg => {
  if (msg.content.includes("bad bot")) {
  ...
  } else if (msg.content.includes(" ein", "dinna", "soleis")) {
    msg.reply(
    ...
    switch (cmd.toLowerCase()) {
      ...
      case "sprinkler":
        msg.channel.send(
          "My sprinkler goes like thisstststststststststststststststststststststststst",
          { tts: true }
        );
        break;
      //------------------------------
      ...
      case "frukt":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://cdn.glitch.com/05aa1396-7f5d-45a3-ab76-baf2815a144a%2Fkurvfrukt.mp3?v=1589659578065"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
      ...
      case "georg":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://cdn.glitch.com/05aa1396-7f5d-45a3-ab76-baf2815a144a%2FGEORG.mp3?v=1589659576813"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
      ...
      case "narko":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://cdn.glitch.com/05aa1396-7f5d-45a3-ab76-baf2815a144a%2Fnaarkotika.mp3?v=1589662311887"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
      ...
      case "narko2":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://cdn.glitch.com/05aa1396-7f5d-45a3-ab76-baf2815a144a%2Fdowns.mp3?v=1589659578314"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
      ...
      case "herren":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://cdn.glitch.com/05aa1396-7f5d-45a3-ab76-baf2815a144a%2Fpriseherren.mp3?v=1589659577913"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
      ...
      case "pul":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://cdn.glitch.com/05aa1396-7f5d-45a3-ab76-baf2815a144a%2Fpatpul.mp3?v=1589659578203"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
      ...
      case "kattepusen":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://cdn.glitch.com/05aa1396-7f5d-45a3-ab76-baf2815a144a%2Fkattepusen.mp3?v=1589659577337"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
      ...
      case "nakokia":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://cdn.glitch.com/05aa1396-7f5d-45a3-ab76-baf2815a144a%2Fnarkotika.mp3?v=1589662459656"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
      ...
      case "ban":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://cdn.glitch.com/05aa1396-7f5d-45a3-ab76-baf2815a144a%2FBan.mp3?v=1589662459737"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
      ...
      case "flue":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://cdn.glitch.com/05aa1396-7f5d-45a3-ab76-baf2815a144a%2Fflue.mp3?v=1589662459879"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
      ...
      case "holy":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://cdn.glitch.com/05aa1396-7f5d-45a3-ab76-baf2815a144a%2Fholy_shit.mp3?v=1589662459678"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
      ...
      case "pubg":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://cdn.glitch.com/05aa1396-7f5d-45a3-ab76-baf2815a144a%2FPUBG.mp3?v=1589662459634"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
      ...
      case "skammekrok":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://cdn.glitch.com/05aa1396-7f5d-45a3-ab76-baf2815a144a%2Fskammekrok.mp3?v=1589662459498"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
      ...
      case "uskyldig":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://cdn.glitch.com/05aa1396-7f5d-45a3-ab76-baf2815a144a%2Fuskyldig.mp3?v=1589662459594"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
      ...
      case "hypo":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://cdn.glitch.com/05aa1396-7f5d-45a3-ab76-baf2815a144a%2Falone.mp3?v=1589738328094"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
      ...
      case "null":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://cdn.glitch.com/05aa1396-7f5d-45a3-ab76-baf2815a144a%2Fninjashit.mp3?v=1589662555361"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
      ...
      case "offer":
        ...
        voiceChannel
          ...
          .then(connection => {
            const dispatcher = connection.play(
              "https://www.myinstants.com/media/sounds/godfather-5.mp3"
            );
            dispatcher.on("finish", end => msg.member.voice.channel.leave());
          })
          .catch(err => console.log(err));
